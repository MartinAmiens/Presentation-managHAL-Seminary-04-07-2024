...
::: {.r-stack}
![Exemple de Réseau trophique, Crédit : (Kéfi et al. 2016)](img/reseau_trophique.png){.fragment width="300" height="300"}

![RAD51 et son réseau d'interaction de sa famille de gènes, Crédits : (Li et al., 2021)](img/Reseau_interaction_genes.png){.fragment width="300" height="300"}

![réseau autre](image3.png){.fragment width="400" height="400"}
:::
