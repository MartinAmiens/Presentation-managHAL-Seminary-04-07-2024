...
## HAL, archive nationale ouverte

**Description de HAL **: Archive nationale pour la diffusion ouverte des résultats de recherche, développée par le CNRS en 2001.

**Utilisation d'API **: Extraction et analyse des données via des outils comme RStudio. décrire peut etre plus en profondeur ?

**Création d'une cellule HAL**: 2 janvier 2023.
...
Je souhaite parler de managHAL en général, de ce qu'il etait possible de faire avant mon stage via les fonctions du package. et fair ele lien vers les réseaux.
