...
```{=html}
<iframe src="Full_Network_Co-authors_Example_managHAL.html"></iframe>
```
## Ajout de fonctionnalité à {managHAL}

### Modélisation en blocs stochastiques

![z](Full_Network_Co-authors_Example_managHAL.html)
...
<object data="Partial_Network_Co-authors_Example_managHAL_sbm.html" width="50%">

</object>{.fragment width="300" height="300"}

<object data="Partial_Network_Co-authors_Example_managHAL.html" width="50%">
...
```{=html}
<object data="Full_Network_Co-authors_Example_managHAL_sbm.html" width="100%" height="600px"></object>
```
