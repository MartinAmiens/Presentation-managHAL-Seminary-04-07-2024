...
<iframe src="img/Full_Network_Co-authors_Example_managHAL_sbm.html" width="100%" height="300px"></iframe>
...
.container {
    ...
    gap: 20px; /* Espace entre les iframes */
}
.iframe-wrapper {
...
<div class="container">
    <div class="iframe-wrapper">
        <iframe src="img/Partial_Network_Co-authors_Example_managHAL_sbm.html"></iframe>
    </div>
    <div class="iframe-wrapper">
        <iframe src="img/Partial_Network_Co-authors_Example_managHAL.html"></iframe>
    </div>
</div>
